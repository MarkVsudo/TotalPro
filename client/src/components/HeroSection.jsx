      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
        ...
        <div>
          <h1 className="text-4xl sm:text-5xl font-bold text-white">
            Професионални услуги за вашите нужни
          </h1>
          <p className="mt-6 text-lg text-gray-100 leading-relaxed">
            Предлагаме пълен набор от услуги – от монтаж и поддръжка на
            климатици, през професионални електроинсталации, до хамалски услуги
            и изграждане на конструкции от гипсокартон. Разчитайте на нас за
            бързо, надеждно и достъпно обслужване.
          </p>
