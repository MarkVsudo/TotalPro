        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="bg-blue-50 p-3 rounded-lg">
                  <FiMapPin className="w-5 h-5 text-[#002B5B]" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-blue-50 p-3 rounded-lg">
                  <PhoneIcon className="w-5 h-5 text-[#002B5B]" />
                </div>
                <div>
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-blue-50 p-3 rounded-lg">
                  <EnvelopeIcon className="w-5 h-5 text-[#002B5B]" />
                </div>
                <div>
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-lg">
              <h3 className="font-semibold text-[#002B5B] mb-3">
                Нашите услуги:
              </h3>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002B5B] focus:border-transparent transition-colors"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
                    <span className="text-gray-600 font-medium">+359</span>
                  </div>
                  <input
                    id="phone"
                    name="phone"
                    ...
                    className="w-full pl-16 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002B5B] focus:border-transparent transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#002B5B] focus:border-transparent transition-colors resize-vertical"
              ...
              <button
                ...
                className="w-full bg-[#002B5B] text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-900 focus:ring-2 focus:ring-[#002B5B] focus:ring-offset-2 transition-colors duration-200"
              >
                Изпрати съобщение
              </button>
