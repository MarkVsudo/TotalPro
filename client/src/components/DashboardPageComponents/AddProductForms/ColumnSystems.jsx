...
const ColumnSystems = () => {
  ...
  const [formData, setFormData] = useState({
    // ✅ Change this to your real category id for Column Systems
    categoryId: 5,
    productCode: "blabla",
    productName: "",
    price: null,
    ...
    heatingEnergyClass: "",
    spec: {
      coolingVolume: null, // Препоръчителен обем (охлаждане) (м³)
      heatingVolume: null, // Препоръчителен обем (отопление) (м³)
      coolingPower: "", // Отдавана мощност (охлаждане) (kW)
      heatingPower: "", // Отдавана мощност (отопление) (kW)
      coolingConsumption: "", // Консумирана мощност (охлаждане) (kW)
      heatingConsumption: "", // Консумирана мощност (отопление) (kW)
      voltage: "", // Захранващо напрежение (V)
      seer: "", // SEER
      scop: "", // SCOP
      noiseIndoor: "", // Ниво на шум (вътрешно тяло) (dB)
      noiseOutdoor: "", // Ниво на шум (външно тяло) (dB)
      sizeIndoor: "", // Размери Ш x В x Д (вътрешно тяло) (mm)
      sizeOutdoor: "", // Размери Ш x В x Д (външно тяло) (mm)
      weightIndoor: "", // Тегло (вътрешно тяло) (kg)
      weightOutdoor: "", // Тегло (външно тяло) (kg)
      workingRangeCooling: "", // Работен диапазон при охлаждане (°C)
      workingRangeHeating: "", // Работен диапазон при отопление (°C)
      refrigerant: "", // Хладилен агент
      origin: "", // Произход
      pipeDiameter: "", // Диаметър на тръбата течност/газ (mm)
      powerSupply: "", // Захранване (пример: Външно)
      powerSupplyType: "", // Тип захранване (пример: Монофазно)
    },
    discount: null,
      ...
      <div className="space-y-6 flex gap-6 w-full">
        ...
        <div className="w-1/2">
          ...
          {[
            ...
            {
              id: "spec.sizeIndoor",
              label: "Размери Ш x В x Д (вътрешно тяло) (mm)",
            },
            {
              id: "spec.sizeOutdoor",
              label: "Размери Ш x В x Д (външно тяло) (mm)",
            },
            { id: "spec.weightIndoor", label: "Тегло (вътрешно тяло) (kg)" },
            { id: "spec.weightOutdoor", label: "Тегло (външно тяло) (kg)" },
            {
            ...
            { id: "spec.origin", label: "Произход" },
            {
              ...
              label: "Диаметър на тръбата течност/газ (mm)",
            },
            { id: "spec.powerSupply", label: "Захранване" },
            { id: "spec.powerSupplyType", label: "Тип захранване" },
          ].map((field) => (
