...
const FloorAirConditioners = () => {
  const [uploadedImages, setUploadedImages] = useState([]);
  const [isSuccess, setIsSuccess] = useState(null);

  const [formData, setFormData] = useState({
    // ✅ Change this to your real category id for Floor ACs
    categoryId: 3,
    productCode: "blabla",
    productName: "",
    price: null,
    ...
    spec: {
      ...
      powerSupply: "", // Захранване
      maxPipeLength: "", // Максимална дължина на тръбния път (м)
      maxDifference: "", // Макс. денивелация външно/вътрешно тяло (м)
    },
    discount: null,
        ...
        <div className="w-1/2">
          ...
          {[
            ...
            },
            {
              ...
              label: "Макс. денивелация външно/вътрешно тяло (м)",
            },
          ].map((field) => (
...
export default FloorAirConditioners;
