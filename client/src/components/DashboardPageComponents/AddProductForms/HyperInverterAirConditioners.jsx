...
const HyperInverterAirConditioners = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    spec: {
      ...
      seer: "", // SEER (сезонна ефективност в режим на охлаждане)
      scop: "", // SCOP (сезонна ефективност в режим на отопление)
      noiseIndoor: "", // Ниво на шум (вътрешно тяло) (dB)
      noiseOutdoor: "", // Ниво на шум (външно тяло) (dB)
      sizeIndoor: "", // Размери Ш x В x Д (вътрешно тяло) (мм)
      sizeOutdoor: "", // Размери Ш x В x Д (външно тяло) (мм)
      weightIndoor: "", // Тегло (вътрешно тяло) (кг.)
      weightOutdoor: "", // Тегло (външно тяло) (кг.)
      ...
      origin: "", // Произход
      pipeDiameter: "", // Диаметър на тръбата течност/газ (мм)
      ...
      <div className="space-y-6 flex gap-6 w-full">
        ...
        <div className="w-1/2">
          ...
          {[
            ...
            {
              id: "spec.seer",
              label: "SEER (сезонна ефективност при охлаждане)",
            },
            {
              id: "spec.scop",
              label: "SCOP (сезонна ефективност при отопление)",
            },
            {
              id: "spec.noiseIndoor",
            ...
            {
              id: "spec.sizeIndoor",
              label: "Размери Ш x В x Д (вътрешно тяло) (мм)",
            },
            {
              id: "spec.sizeOutdoor",
              label: "Размери Ш x В x Д (външно тяло) (мм)",
            },
...
export default HyperInverterAirConditioners;
