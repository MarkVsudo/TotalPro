...
const MultiSplitSystems = () => {
  ...
  const [formData, setFormData] = useState({
    // ✅ Change this to your real category id for Multi Split Systems
    categoryId: 4,
    productCode: "blabla",
    productName: "",
    price: null,
    ...
    spec: {
      ...
      seer: "", // SEER
      scop: "", // SCOP
      pipeDiameter: "", // Диаметър на тръбите (mm)
      ...
      maxPipeLength: "", // Максимална дължина на тръбния път/до всяко тяло (m)
      indoorUnitsCount: "", // Брой вътрешни тела
    },
    discount: null,
      ...
      <div className="space-y-6 flex gap-6 w-full">
        ...
        <div className="w-1/2">
          ...
          {[
            ...
            { id: "spec.pipeDiameter", label: "Диаметър на тръбите (mm)" },
            {
            ...
            { id: "spec.refrigerant", label: "Хладилен агент" },
            {
              ...
              label: "Максимална дължина на тръбния път/до всяко тяло (m)",
            },
            { id: "spec.indoorUnitsCount", label: "Брой вътрешни тела" },
          ].map((field) => (
