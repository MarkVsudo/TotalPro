...
const CassetteAirConditioners = () => {
  ...
  const [formData, setFormData] = useState({
    // ✅ Change this to your real category id for Cassette ACs
    categoryId: 6,
    productCode: "blabla",
    productName: "",
    price: null,
    ...
    spec: {
      ...
      powerSupply: "", // Захранване (пример: Външно и вътрешно)
      maxPipeLength: "", // Максимална дължина на тръбния път (m)
      maxDifference: "", // Макс. денивелация външно/вътрешно тяло (m)
        ...
        <div className="w-1/2">
          ...
          {[
            ...
            { id: "spec.powerSupply", label: "Захранване" },
            {
              ...
              label: "Максимална дължина на тръбния път (m)",
            },
            {
              id: "spec.maxDifference",
              label: "Макс. денивелация външно/вътрешно тяло (m)",
            },
